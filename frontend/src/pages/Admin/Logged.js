...
const Logged = () => {
    const { currentAccount, isAdmin } = JSON.parse(localStorage.getItem("userData"))
    ...
    return (
        <>
            ...
            {isAdmin ?
                <h1>Welcome <a href={`https://rinkeby.etherscan.io/address/${MAINCONTRACTADDRESS}`} target="_blank" rel="noreferrer" >Admin</a>, {currentAccount.slice(0, 5)}...{currentAccount.slice(38)}!</h1> :
                <>
